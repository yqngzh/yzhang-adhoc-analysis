...
create or replace table `etsy-sr-etl-prod.yzhang.qtd_level2full_tire_sanity_raw` as (
...
create or replace table `etsy-sr-etl-prod.yzhang.qtd_level2full_tire_sanity_full` as (
    select r.*, p.qtd_distrib, p.listing_taxo_distrib, p.distrib_distance
    from `etsy-sr-etl-prod.yzhang.qtd_level2full_tire_sanity_raw` r
    join `etsy-sr-etl-prod.yzhang.qtd_level2full_tire_sanity_processed` p
    on r.uuid = p.uuid
...
FROM `etsy-sr-etl-prod.yzhang.qtd_level2full_tire_sanity_full` 
...
with tmp as (
    ...
    from `etsy-sr-etl-prod.yzhang.qtd_level2full_tire_sanity_match`
