create or replace table `etsy-sr-etl-prod.yzhang.sem-rel-pw-tire-boe-log1p` as (
    with tire_requests as (
        ...
        where tireRequestContext.tireTestv2Id = "kjHjQK89FadtyK5ucWEa"
        and request.query != ""
...
with grouped as (
    ...
    from `etsy-sr-etl-prod.yzhang.sem-rel-pw-tire-boe-log1p`
    where page_no = 1
