...
"""
<_PrefetchDataset element_spec=({'source': TensorSpec(shape=(None,), dtype=tf.string, name=None), 'labels_3': TensorSpec(shape=(None,), dtype=tf.int64, name=None), 'probas_3': TensorSpec(shape=(None, 3), dtype=tf.float64, name=None), 'query_char_3grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'query_word_1grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'query_word_2grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'title_char_3grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'tags_char_3grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'title_word_1grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'tags_word_1grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'title_word_2grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'tags_word_2grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'taxonomyPath': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'title': TensorSpec(shape=(None,), dtype=tf.string, name=None), 'title_tokens': RaggedTensorSpec(TensorShape([None, None]), tf.int32, 1, tf.int64), 'shop_char_3grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'shop_word_1grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'shop_word_2grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'desckw_char_3grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'desckw_word_1grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64), 'desckw_word_2grams': RaggedTensorSpec(TensorShape([None, None]), tf.int64, 1, tf.int64)}, TensorSpec(shape=(None, 3), dtype=tf.float64, name=None))>
"""