...
class CachedSemrelModel(tf.keras.models.Model):
    def __init__(
        ...
        shopname_emb: tf.Variable,
        semrel_model: SemrelModel,
        nir_model,
    ):
        """
        ...
        :param shopname_emb: 2-d tensor (N_LISTINGS x EMB_DIM) with shop name embeddings for every listing
        ...
        self.shopname_embs = shopname_emb
    ...
    def call(self, inputs: ModelInput):
        ...
        embs = {
            ...
            "shopname": tf.gather(self.shopname_embs, valid_idxs),
        }
        for k in list(embs):
        ...
        logits = self.semrel_model.score_query_listing(
        ...
        shop_scores = tf.reduce_sum(nir_query_emb * embs["shopname"], axis=1)
